...
namespace Castor {
    ...
    class Context implements \ArrayAccess
    {
        ...
        public function __construct(
            ...
            public readonly \Castor\Console\Output\VerbosityLevel|\Castor\VerbosityLevel $verbosityLevel = \Castor\Console\Output\VerbosityLevel::NOT_CONFIGURED,
            /**
             * @internal
    ...
    trigger_deprecation('castor/castor', '0.16', 'The "%s" class is deprecated and will be removed in castor 1.0. Use the "%s::getContainer()" instead.', \Castor\GlobalHelper::class, \Castor\Console\Application::class);
    #[\Symfony\Component\DependencyInjection\Attribute\Exclude]
    class GlobalHelper
    {
    ...
    function zip(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
    {
    }
    function zip_binary(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
    {
    }
    function zip_php(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
    {
    }
    /**
...
namespace Castor\Helper {
    ...
    class ZipArchiver
    {
        ...
        public function zip(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
        {
        }
        public function zipWithBinary(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
        {
        }
        public function zipWithPhp(string $source, string $destination, #[\SensitiveParameter] ?string $password = null, \Castor\Helper\CompressionMethod $compressionMethod = \Castor\Helper\CompressionMethod::DEFLATE, int $compressionLevel = 6, bool $overwrite = false): void
        {
        }
    }
}
